...
if("TRUE" STREQUAL "TRUE")
  set(quadrotor_msgs_SOURCE_PREFIX /home/jacob/fuel_star_ws/src/FUEL/uav_simulator/Utils/quadrotor_msgs)
  set(quadrotor_msgs_DEVEL_PREFIX /home/jacob/fuel_star_ws/devel)
  ...
  set(quadrotor_msgs_INSTALL_PREFIX /home/jacob/fuel_star_ws/install)
...
if(NOT "/home/jacob/fuel_star_ws/devel/include " STREQUAL " ")
  set(quadrotor_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/jacob/fuel_star_ws/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://ros.org/wiki/quadrotor_msgs " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/quadrotor_msgs' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'quadrotor_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jacob/fuel_star_ws/src/FUEL/uav_simulator/Utils/quadrotor_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT quadrotor_msgs_NUM_DUMMY_TARGETS)
      set(quadrotor_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::quadrotor_msgs::wrapped-linker-option${quadrotor_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR quadrotor_msgs_NUM_DUMMY_TARGETS "${quadrotor_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::quadrotor_msgs::wrapped-linker-option${quadrotor_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND quadrotor_msgs_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND quadrotor_msgs_LIBRARIES ${library})
