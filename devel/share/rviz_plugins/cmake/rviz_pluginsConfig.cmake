...
if("TRUE" STREQUAL "TRUE")
  set(rviz_plugins_SOURCE_PREFIX /home/jacob/fuel_star_ws/src/FUEL/uav_simulator/Utils/rviz_plugins)
  set(rviz_plugins_DEVEL_PREFIX /home/jacob/fuel_star_ws/devel)
  ...
  set(rviz_plugins_INSTALL_PREFIX /home/jacob/fuel_star_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jacob/fuel_star_ws/src/FUEL/uav_simulator/Utils/rviz_plugins/${idir}'.  ${_report}")
    endif()
...
set(depends "multi_map_server;message_runtime")
