...
if("TRUE" STREQUAL "TRUE")
  set(waypoint_generator_SOURCE_PREFIX /home/jacob/fuel_star_ws/src/FUEL/uav_simulator/Utils/waypoint_generator)
  set(waypoint_generator_DEVEL_PREFIX /home/jacob/fuel_star_ws/devel)
  ...
  set(waypoint_generator_INSTALL_PREFIX /home/jacob/fuel_star_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'waypoint_generator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jacob/fuel_star_ws/src/FUEL/uav_simulator/Utils/waypoint_generator/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(waypoint_generator_EXPORTED_TARGETS ${${waypoint_generator_dep}_EXPORTED_TARGETS})
endforeach()
